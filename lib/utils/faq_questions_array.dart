final List<Map<String, String>> faqs = const [
  {
    ...
    "answer":
        "W naszej szkole nie istniała żadna aplikacja, która kompleksowo wspierałaby przygotowania do egzaminów zawodowych. "
        ...
        "Proces ten był niewygodny, a rozwiązywanie zadań nie zawsze rzetelnie odzwierciedlało ich realną wiedzę — chociażby ze względu na łatwość ściągania. "
  ...
  },
  {
    ...
    "answer":
        "Front-end aplikacji został w całości napisany w Dart'cie, natomiast część back-endowa opiera się na PHP oraz bazie danych SQL. "
        ...
        "Dart'a wybraliśmy dlatego, że umożliwia nam tworzenie aplikacji na wiele platform jednocześnie — nie tylko jako strony internetowej, ale również aplikacji desktopowych i mobilnych. "
        "Posiada też bogaty ekosystem bibliotek, co znacznie usprawniło i przyspieszyło naszą pracę.",
  },
  {
    "question": "3. Co było najtrudniejsze w tworzeniu aplikacji?",
    "answer":
        ...
        "Wyzwanie stanowił też sam język — nikt z nas wcześniej nie pracował w Dart'cie. Zdecydowaliśmy się jednak spróbować i dziś wiemy, że była to świetna decyzja, bo zdobyliśmy cenne doświadczenie i nauczyliśmy się pracy z nową technologią.\n\n"
  ...
  {
    "question": "4. Co daje Wam największą satysfakcję z pracy nad projektem?",
    "answer":
