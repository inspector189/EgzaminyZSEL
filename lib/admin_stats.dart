...
class _AdminStatsPageState extends State<AdminStatsPage> {
  ...
  void _recompute() {
    ...
    setState(() {
      ...
      _allQualificationKeys = validKeys.toList()..sort();
      if (selectedQualification != null &&
          !validKeys.contains(selectedQualification)) {
...
class _UserCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final exams = List<dynamic>.from(userData['exams'] as List)
      ..sort((a, b) {
...
class _QualificationCardV2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color accentColor = avg >= 75
        ? extras.correct
        : avg >= 50
        ? cs.primary
        : extras.incorrect;
    final Color accentBg = avg >= 75
